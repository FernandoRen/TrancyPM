			...
			<div class="col-md-4">
				...
				<form>
				  <div class="form-group">
				    <label for="providerName">Trucking Company name</label>
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="providerState" name="providerState" placeholder="Type State">
				  </div>
				  
				  <div class="text-center">
				  	<button type="submit" class="btn btn-primary">Add Trucking Company</button>
				  </div>
				</form>
			</div>
